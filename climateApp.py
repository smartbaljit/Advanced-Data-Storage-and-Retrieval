...
def welcome():
   ...
   <a href="/api/v1.0/stations">/api/v1.0/stations</a>
    ...
    <br>
    <br>
    <a href="/api/v1.0/2017-01-01/2017-01-10">/api/v1.0/2017-01-01/2017-01-10</a>
    </li>
    <br>
    </ul>
    </html>
...
def precipitation():
    ...
    yr_bef = dt.datetime.strptime(max_date, "%Y-%m-%d") - dt.timedelta(days=365)
    
    # Perform a query to retrieve the data and precipitation scores
    results_precipitation = session.query(Measurement.date, Measurement.prcp).filter(Measurement.date >= yr_bef).all()
...
def tobs(): 
    ...
    yr_bef = dt.datetime.strptime(max_date, "%Y-%m-%d") - dt.timedelta(days=365)
    # Query tobs
    results_tobs = session.query(Measurement.date, Measurement.tobs).filter(Measurement.date >= yr_bef).all()
